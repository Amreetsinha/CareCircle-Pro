    ...
    <div className="min-h-screen pt-[80px] pb-12 px-6">
      <div className="max-w-[1024px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[180px]">
          ...
          {/* Edit Profile */}
          <div className="card-apple flex flex-col justify-center items-center text-center cursor-pointer group hover:bg-[#f5f5f7]" onClick={() => navigate("/parent-profile")}>
            ...
            <span className="text-sm font-medium text-[#1d1d1f]">Edit Profile</span>
          </div>
